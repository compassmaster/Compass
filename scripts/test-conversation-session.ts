...
assert.deepEqual(extractedCalendar.calendarCapture.candidate?.draft, { title:'歯医者',note:'',timeKind:'TIMED',startDate:'',endDate:'',startsAt:`${resolvedTomorrow}T14:00`,endsAt:`${resolvedTomorrow}T15:00`,timeZone:Intl.DateTimeFormat().resolvedOptions().timeZone || 'UTC' });
