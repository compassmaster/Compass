...
import type { LifeTimelineSourceReader, SourceReadResult } from './lifeTimelineSourceReader.ts';
...
export const compareLifeTimelineItems = (a: LifeTimelineItem, b: LifeTimelineItem) => textCompare(a.displayDate, b.displayDate) || bucketRank[a.sortBucket] - bucketRank[b.sortBucket] || textCompare(a.sortKey, b.sortKey) || typeRank[a.recordType] - typeRank[b.recordType] || textCompare(a.sourceRecordId, b.sourceRecordId);
