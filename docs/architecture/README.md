...
- [D-0021 自由会話のConversation sessionと一時文脈](D-0021-conversation-session-and-transient-context.md): 非永続session / message、request lifecycle、順序・cancel・retry、有限context、Captureを維持する自由会話reset、決定論的Captureとの優先順位。
